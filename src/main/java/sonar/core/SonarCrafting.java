...
public class SonarCrafting extends SonarCore {
	...
	public static void registerCraftingRecipes() {
		...
		addShapedOre(new ItemStack(SonarCore.reinforcedStoneGate, 1), new Object[] { "SAS", "SAS", 'A', SonarCore.reinforcedStoneBlock, 'S', "stickWood"});
	    addShapedOre(new ItemStack(SonarCore.reinforcedStoneBrickGate, 1), new Object[] { "SAS", "SAS", 'A', SonarCore.reinforcedStoneBrick, 'S', "stickWood"});
	    addShapedOre(new ItemStack(SonarCore.reinforcedDirtGate, 1), new Object[] { "SAS", "SAS", 'A', SonarCore.reinforcedDirtBlock, 'S', "stickWood"});
	    addShapedOre(new ItemStack(SonarCore.reinforcedDirtBrickGate, 1), new Object[] { "SAS", "SAS", 'A', SonarCore.reinforcedDirtBrick, 'S', "stickWood"});
